 ...
 * fails to start.
 *
 * <p>This is a plain POJO with no Spring annotations so it lives in the framework-neutral
 * core. Each starter binds it to the {@code audit.*} properties (see the starter's
